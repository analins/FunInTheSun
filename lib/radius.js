...
function loadCityData (req) { //CHANGE from dbCity to randomTen for Radius search -Ana
    ...
    console.log(randomTenArr);
    //REMOVE if statement..there will always be a randomTen in radius search if (!randomTenArr.length) {
    //     console.log("Returning error.");
    //     return response( {code: 404, description: "No favorite cities."} ); } //No favorites on user

    //for each city in the user's city list
    for (var i = 0; i < randomTenArr.length; i++) {
