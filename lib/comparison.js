...
var url = "http://api.wunderground.com/api/"+ process.env.APIKEY + "/features/forecast10day/q/__zipcode__.json";
var citiesArr=[];
var response;
...
function performLogic(req, res) {
    ...
    response = function(){
        ...
        res.json({cities: citiesArr}); //res saved in closure
    };
}
...
function comparison () {
    ...
    return response(); //Last function. When done call the response.
}
